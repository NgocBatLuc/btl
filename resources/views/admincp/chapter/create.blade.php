                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('chapter.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="slug" value="{{old('tieude')}}" onkeyup="ChangeToSlug();" name="tieude" aria-describedby="tendanhmucHelp" placeholder="Tên chapter ...">
<!--                             <small id="tendanhmucHelp" class="form-text text-muted">Vui lòng nhập tên danh mục</small> -->
                        </div>
                        
                        <div class="form-group">
                            <label for="danhmuc">Slug chapter</label>
                            <input type="text" class="form-control" id="convert_slug" value="{{old('slug_chapter')}}" name="slug_chapter" placeholder="Slug chapter ...">
<!--                             <small id="tendanhmucHelp" class="form-text text-muted">Vui lòng nhập tên danh mục</small> -->
                        </div>

                        <div class="form-group">
                            <label for="danhmuc">Tóm tắt chapter</label>
                            <input type="text" class="form-control" id="motadanhmuc" value="{{old('tomtat')}}" name="tomtat" aria-describedby="motadanhmucHelp" placeholder="Tóm tắt  ...">
<!--                             <small id="motadanhmucHelp" class="form-text text-muted">Vui lòng mô tả danh mục</small> -->
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="noidung" class="form-control" style="resize: none;"></textarea>
                        </div>
                        <div class="form-group">
